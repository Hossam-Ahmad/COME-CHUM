...
@Component({
  selector: 'app-forget-website',
  templateUrl: './forget-website.component.html',
  styleUrls: ['./forget-website.component.scss']
})
export class ForgetWebsiteComponent implements OnInit {
